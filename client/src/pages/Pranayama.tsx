...
const TECHNIQUES: PranayamaTechnique[] = [
  ...
  },
  {
    ...
    maxRounds: 5,
    phases: [
      { type: "inhale", duration: 4, label: "Deep inhale — fill lungs completely" },
      { type: "exhale", duration: 4, label: "Slow exhale — empty lungs" },
      { type: "exhale", duration: 1, label: "Rapid exhale 1 — pump belly" },
      { type: "exhale", duration: 1, label: "Rapid exhale 2" },
      { type: "exhale", duration: 1, label: "Rapid exhale 3" },
      { type: "exhale", duration: 1, label: "Rapid exhale 4" },
      { type: "exhale", duration: 1, label: "Rapid exhale 5" },
      { type: "exhale", duration: 1, label: "Rapid exhale 6" },
      { type: "exhale", duration: 1, label: "Rapid exhale 7" },
      { type: "exhale", duration: 1, label: "Rapid exhale 8" },
      { type: "exhale", duration: 1, label: "Rapid exhale 9" },
      { type: "exhale", duration: 1, label: "Rapid exhale 10" },
      { type: "exhale", duration: 1, label: "Rapid exhale 11" },
      { type: "exhale", duration: 1, label: "Rapid exhale 12" },
      { type: "exhale", duration: 1, label: "Rapid exhale 13" },
      { type: "exhale", duration: 1, label: "Rapid exhale 14" },
      { type: "exhale", duration: 1, label: "Rapid exhale 15" },
      { type: "exhale", duration: 1, label: "Rapid exhale 16" },
      { type: "exhale", duration: 1, label: "Rapid exhale 17" },
      { type: "exhale", duration: 1, label: "Rapid exhale 18" },
      { type: "exhale", duration: 1, label: "Rapid exhale 19" },
      { type: "exhale", duration: 1, label: "Rapid exhale 20" },
    ...
    instructions: [
      ...
      "Exhale slowly and fully to prepare",
      "Begin rapid, forceful exhales through the nose by pumping the belly",
      "Inhalation happens passively between each exhale — don't focus on it",
      "Complete 20 rapid exhales per round",
